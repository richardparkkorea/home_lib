...
------------------------------------------------------------------------------*/
	...
	public String getStringProperty(String pstrSection, String pstrProp, String def) {
		if (getStringProperty(pstrSection, pstrProp) == null) {
			setStringProperty(pstrSection, pstrProp, def, null);
			this.save();
		}
		return getStringProperty(pstrSection, pstrProp);
	}
 ...
 *----------------------------------------------------------------------------*/
     ...
     */
    public static void test(String[] pstrArgs)
    {
        IniFile objINI = null;
        String  strFile = "test.ini";
...
//        
        ...
        System.out.format("everythings gonna be ok\n");
    }
