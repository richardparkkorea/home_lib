...
public class NqPacket {
	 ...
	 * @return
	 */
	public NqPacket setBufferSize(long l) {
		  m_bufferSize=l;
		return this;
	}
	 ...
	 * @return
	 */
	public static byte[] make(NqItem m) throws Exception {
	 ...
	 * @return
	 */
	public NqItem poll()   throws Exception  {
