...
public interface MqBrokerListener {
	...
	public void returnError(MqBroker mqBroker, NqServer svr, NqConnector con, UserException e);
	
	public boolean login(MqBroker mqBroker, NqServer svr, NqConnector nqConnector, String id, String pwd);
