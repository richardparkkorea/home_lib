...
public class MqttSelector {
	...
	private MqttSelectorListener m_svr = null;
	...
	public MqttSelector(MqttSelectorListener svr) {
		// m_bootstrap = bs;
		m_svr = svr;
	}
	
	public MqttSelector bind(String ip, int port) throws Exception {
		return bind(ip,port,0);
	}

	public MqttSelector bind(final String ip, final int port, int backlog) throws Exception {
