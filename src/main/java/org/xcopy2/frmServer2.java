...
public class frmServer2 extends JFrame {

	private JPanel contentPane;
	private JTextField txtPort;

	IoHandle2 m_server = null;
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				if (SystemTray.isSupported()) {
					...
					int response = JOptionPane.showConfirmDialog(frmServer2.this, // owner
							"exit?", // message
							"confirm", // title
	...
	void start() {
		...
		try {
			...
			m_server = new IoHandle2(m_ip, port, true);
	...
	public void putOnTray() {
		...
		final TrayIcon trayIcon = new TrayIcon(XcMain2.createImage("cloud-data.png", "tray icon"));
		...
		trayIcon.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frmServer2.this.setVisible(true);
