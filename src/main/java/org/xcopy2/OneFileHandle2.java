...
import home.lib.net.tms.mqtt3.sup.IMySocketSupListener;
import home.lib.net.tms.mqtt3.sup.MySocketSup;
...
public class OneFileHandle2 {

	OneFileHandle2 _this = this;

	public String m_baseDir = "";

	public MySocketSup m_client = null;
	...
	public FilePacket2 m_remoteWritingState = new FilePacket2();
	...
	public OneFileHandle2(String id, String svrIp, int svrPort) throws Exception {
		...
		try {
			m_client = new MySocketSup(null, id, svrIp, svrPort, new DefaultMqSocketListener());
	...
	public boolean r_isFile(String name) throws Exception {
		...
		System.out.println("r_isfile="+name);
...
class DefaultMqSocketListener implements IMySocketSupListener {
