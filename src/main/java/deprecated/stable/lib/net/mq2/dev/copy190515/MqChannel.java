...
public class MqChannel {
	...
	private class ReadAttachment {
		...
		ByteBuffer buffer;
		MqChannelInterface listener = null;
		String ip="";
	...
	protected MqChannelInterface m_inter = null;
	 ...
	 * @throws Exception
	 */
	public MqChannel setIpBind(InetSocketAddress b) throws Exception {
	 ...
	 * @return
	 */
	public MqChannel setUserObject(Object o) {
		m_user_obj = o;
		return this;
	}
	 ...
	 * @return
	 */
	public MqChannel setSocketBufferSize(long l) {
	 ...
	 * @throws Exception
	 */
	public MqChannel connect(final String ip, final int port, final MqChannelInterface l) throws Exception {
		...
		synchronized (m_executor) {
			...
			if (m_selector != null) {
				throw new UserException("it works with selector!");
			}
	 ...
	 * @return
	 */
	public MqChannel waitConnect(double d) {
	...
	public static String debug(String f, Object... p) {
		String m = "mqchannel " + String.format(f, p);
	 ...
	 * @return
	 */
	public MqChannel accept(AsynchronousSocketChannel ch, MqChannelInterface l) throws Exception {
	 ...
	 * @return
	 */
	protected MqChannel accept(MqSelector sel, SocketChannel ch, MqChannelInterface l) {
		m_isAccept = true;
